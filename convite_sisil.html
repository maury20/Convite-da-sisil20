...
<body class="flex items-center justify-center min-h-screen p-4 sm:p-6">
    ...
    <div class="max-w-md w-full bg-white paper-shadow rounded-3xl overflow-hidden border border-gray-100">
        ...
        <div class="p-6 sm:p-8 space-y-6">
            ...
            <div class="text-center">
                <h3 class="font-sport text-2xl text-gray-900 leading-tight">A nossa meta é celebrar!</h3>
                <p class="text-gray-500 text-sm mt-2 leading-relaxed">
                    Junte-se ao nosso pelotão para uma comemoração inesquecível na orla.
                </p>
            </div>
            ...
            <div class="flex items-center gap-4 bg-gray-50 p-4 rounded-2xl border border-gray-100">
                ...
                <div class="flex-1 text-sm">
                    ...
                    <div class="text-pink-600 font-bold mt-1 uppercase text-[10px] tracking-wider">Traje: Esportivo & Rosa 👟</div>
                </div>
            </div>

            <!-- Lista de Presentes -->
            <div class="bg-pink-50/50 rounded-2xl p-5 border border-pink-100">
                <h4 class="font-sport text-lg text-pink-700 mb-3 flex items-center gap-2">
                ...
                <ul class="grid grid-cols-1 gap-2 text-sm text-gray-700">
                    <li class="flex items-center gap-2 font-medium">
                        <span class="text-pink-400">•</span> Acessórios
                    </li>
                    <li class="flex items-center gap-2 font-medium">
                        <span class="text-pink-400">•</span> Perfumes / Hidratante
                    </li>
                    <li class="flex items-center gap-2 font-medium">
                        <span class="text-pink-400">•</span> Bolsas
                    </li>
                    <li class="flex items-center gap-2 font-medium">
                        <span class="text-pink-400">•</span> Itens de beleza
                    </li>
            ...
            <div class="space-y-3 pt-2">
                <input type="text" id="guestName" placeholder="Digite seu nome para confirmar" 
                    class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-pink-500 focus:border-transparent outline-none transition-all text-sm">
                
                <button id="whatsappBtn" class="w-full bg-gray-900 text-white font-sport text-xl py-4 rounded-xl shadow-xl hover:bg-black transition-colors flex items-center justify-center gap-3">
        ...
        <div class="bg-gray-50 border-t border-gray-100 px-8 py-5 flex justify-between items-center italic">
            <span class="text-[10px] font-bold text-gray-400 uppercase tracking-[0.2em]">Sisil B-Day Run 2026</span>
            <div class="flex gap-[2px]">
                <div class="w-[1px] h-3 bg-gray-300"></div>
                <div class="w-[3px] h-3 bg-gray-300"></div>
                <div class="w-[1px] h-3 bg-gray-300"></div>
                <div class="w-[2px] h-3 bg-gray-300"></div>
            </div>
        </div>
    </div>
